export const catchuTestItems: CatchuTestItem[] = [
  {
    index: '1',
    question: '오늘 점심 메뉴로 나온 맛있는 반찬😋 근데 딱 한 개라면?',
    answer: {
  ...
  {
    index: '2',
    question: '유럽 여행을 간다면 더 해보고 싶은 것은',
    answer: {
  ...
  {
    index: '5',
    question: '여유롭게 산책하던 중... 앗, 길을 잘못 들었다!',
    answer: {
      a: '오히려 좋아, 새로운 곳 탐험~.~',
  ...
  {
    index: '9',
    question: '추억 소환, 갑자기 리코더에 꽂힌 당신.',
    answer: {
      a: '어느 세월에 연습해~ 리코더 연주 영상을 재생한다.',
      b: '직접 연주해보고 싶어...! 당장 문구점에서 리코더를 사온다.',
    },
    type: '성실성',
  },
  {
  ...
  {
    index: '11',
    question: '이봐 캐사원, 다음 프로젝트는 어떤 팀에 들어가겠나?',
    answer: {
  ...
  },
  {
    index: '12',
    question:
      '맘에 드는 옷 발견! 검은색이 눈에 들어오는데 흰색이 더 어울린다는 친구의 한마디...',
    answer: {
      a: '보는 사람 눈이 정확하겠지~ 친구 말 듣고 흰색 산다⚪️',
      b: '그래도 내 마음에 드는 게 우선이지! 먼저 눈에 들어온 검은색 산다⚫️',
    },
    type: '우호성',
  },
];
